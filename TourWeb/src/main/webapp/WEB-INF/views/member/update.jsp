...
<!-- 								</li> -->
								...
								<li class="clear">
									...
									<c:if test="${memberDTO.gender eq '여'}">	
										...
										<input type="radio" class="css-radio" id="www_lbl" name="gender" value="여" checked><label for="www_lbl">여</label>
									</c:if>	
...
<!-- 								</li> -->
								<li class="clear">
									...
									<c:if test="${memberDTO.agree eq 'disagree'}">
										<input type="radio" class="css-radio" id="smsyes_lbl" name="agree" value="agree"><label for="smsyes_lbl">동의</label>
										<input type="radio" class="css-radio" id="smsno_lbl" name="agree" value="disagree" checked><label for="smsno_lbl">동의안함</label>
									</c:if>	
